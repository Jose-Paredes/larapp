<template>
    ...
    <div v-if="notifications.length"> <!--./ Si existen notificaciones-->
...
<script>
    export default {
        ...
        computed: {
            // Estan atentas a cambios y realizan algo como respuesta
            listar: function () {
                ...
                if (this.notifications == '') {
                    ...
                    if (this.arrayNotifications.length > 3) {
                        // Si el tamano es mayor a 3 Es cuando las notificaciones son obteneidas desde axios
                        return Object.values(this.arrayNotifications[4]);
                    } else {
                        // Si el tamano es < 3 Es cuando las notificaciones son obtenidas desde el canal privado
