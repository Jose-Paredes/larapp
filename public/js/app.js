...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        registrarCategoria: function registrarCategoria() {
            ...
            var me = this; // Hace ref a este mismo archivo
        ...
        desactivarCategoria: function desactivarCategoria(id) {
            ...
            swalWithBootstrapButtons({
                ...
                if (result.value) {
                    ...
                    var me = _this; // Hace ref a este mismo archivo
                    // AXIOS, recibe 2 parametros; ruta + parametros
                    axios.put('/categoria/desactivar', {
                        ...
                        // Si todo va bien
                        me.listarCategoria();
                        swalWithBootstrapButtons('Desactivado!', 'El registro a sido desactivado con exito.', 'success');
                    }).catch(function (error) {
                        // Si hay errores
                        console.log(error);
                    });
            ...
            swalWithBootstrapButtons({
                ...
                if (result.value) {
                    ...
                    axios.put('/categoria/activar', {
                        ...
                        // Si todo va bien
                        me.listarCategoria();
                        swalWithBootstrapButtons('Activado!', 'El registro a sido activado con exito.', 'success');
                    }).catch(function (error) {
                        // Si hay errores
                        console.log(error);
                    });
